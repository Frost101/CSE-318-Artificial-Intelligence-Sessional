...
public class Statistics {
    ...
    public static void main(String[] args) {
        System.out.println("Generating Statistics....Please wait....");
        for(int  heursiticAI1 = 1; heursiticAI1 <=4; heursiticAI1++){
            for(int heursiticAI2 = heursiticAI1; heursiticAI2 <=4; heursiticAI2++){
